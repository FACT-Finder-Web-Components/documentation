...
declare module scope.common {
     ...
     * @returns {string}
     */
    function dictToParameterString(dict: any): string;
    /**
     ...
     * @param value
     */
    function setUrlParameter(name: string, value?: any): void;
    function encodeUrl(url: any): string;
    /**
...
declare module scope.communication {
    ...
    module Util {
        ...
        function pushParameterToHistory(result: any, urlString: any, ffEventType: any): void;
        /**
    ...
    module ResultDispatcher {
         ...
         */
        function dispatchResultByTopic(response: any, topic: any): void;
        /**
         ...
         */
        function dispatchCampaigns(result: any): void;
        /**
         ...
         */
        function dispatchPageCampaigns(pageCampaigns: any): void;
        /**
         ...
         */
        function dispatchProductCampaigns(campaigns: any): void;
        /**
         ...
         */
        function dispatchShoppingCartCampaign(campaigns: any): void;
        /**
         ...
         * @param type
         */
        function _doCampaingDispatch(campaigns: any, type: any): void;
        /**
         ...
         */
        function dispatchSimilarProducts(similarProducts: any): void;
        /**
         ...
         * @param result
         */
        function dispatchTagCloud(result: any): void;
        /**
         * Dispatches the 'query' on a searchResult to the topic 'query'
         * @param result
         */
        function dispatchQuery(result: any): void;
        /**
         ...
         * @param event
         */
        function dispatchNavigationFrame(result: any): void;
    }
