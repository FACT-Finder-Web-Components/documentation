...
| **sid**&nbsp;(String) **any** | A session identifier parameter used in every request sent to FACT-Finder. We recommend no to set this attribute manually as it is generated automatically by Web Components. If for some case you have to overwrite it, please keep in mind that it must be **exactly 30 character length**. |
