...
| **category-page**&nbsp;(String)&nbsp;(default: empty) | _The parameter string has to be URL-encoded._ **TODODO** With this property you can deliver standard parameters which will then be attached to the search request. Example: `add-params="param1=abcd,param2=xyz"` |
