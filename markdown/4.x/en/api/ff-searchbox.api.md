...
| **hide-suggest-onblur**&nbsp; (String) **Options**: &nbsp;"true", &nbsp;"false" (default: "true") | Always set to `"false"` and use `ff-suggest`'s `hide-onblur="true"` instead. Determines if suggestions are hidden as soon as the cursor leaves the input field. This property is intended for development and styling purposes. |
