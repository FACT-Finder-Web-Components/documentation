...
role `price` to your field `prix` in the FACT-Finder-UI. In order to use the [Currency Attributes](/documentation/4.x/currency-guide) on your product detail page, you have to map `price` to
