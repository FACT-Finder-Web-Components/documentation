...
To use custom navigation data instead of data retrieved from FactFinder, set `subscribe="false"` and assign an array of navigation items to the `navigationData` property.
