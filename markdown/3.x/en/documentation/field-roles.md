...
role `price` to your field `prix` in the FactFinder-UI. In order to use the [Currency Attributes](/documentation/3.x/currency-guide) on your product detail page, you have to map `price` to
